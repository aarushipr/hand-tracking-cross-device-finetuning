...
/*!
 * @file
 * @brief Implementation of the IVRCompositor interface version 026.
 *
...
class XRTVRCompositor_026 : public XRTVRCompositor_029, public vr::IVRCompositor_026
{
public:
	// @todo Remove when clang-format is updated in CI
	// clang-format off
	XRTVRCompositor_026(XRTVRClientCore_003 *core) : XRTVRCompositor_029(core) {};
	// clang-format on
