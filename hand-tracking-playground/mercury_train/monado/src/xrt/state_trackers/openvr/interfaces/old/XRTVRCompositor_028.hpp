...
/*!
 * @file
 * @brief Implementation of the IVRCompositor interface version 028.
 *
...
class XRTVRCompositor_028 : public XRTVRCompositor_029, public vr::IVRCompositor_028
{
public:
	// @todo Remove when clang-format is updated in CI
	// clang-format off
	XRTVRCompositor_028(XRTVRClientCore_003 *core) : XRTVRCompositor_029(core) {};
	// clang-format on
	...
	Forward_IVRCompositor_SubmitWithArrayIndex();
	...
	Forward_IVRCompositor_FadeGrid_029();
	...
	Forward_IVRCompositor_GetCompositorBenchmarkResults();
	Forward_IVRCompositor_GetLastPosePredictionIDs();
	Forward_IVRCompositor_GetPosesForFrame();
};
