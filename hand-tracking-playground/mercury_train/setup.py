...
setup(
    name="ad4_stereographic_projection",
    version="0.0.1",
    author="Meow Meow",
    author_email="moses@collabora.com",
    description="Library for stereographic projections for ",
    long_description="",
    ext_modules=[CMakeExtension("ad4_stereographic_projection")],
